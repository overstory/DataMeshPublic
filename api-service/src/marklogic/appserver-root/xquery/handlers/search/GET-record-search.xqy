...
declare variable $search-criteria :=
    ...
    return
        <oss:search-criteria>
            <oss:request-url>{xdmp:url-decode (xdmp:get-original-url())}</oss:request-url>
...
return
	...
	then (
		...
		let $results := s:perform-search ($sparql-query, $cts-query, $search-criteria, $collection, $wants-atom)
